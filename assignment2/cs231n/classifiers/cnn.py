...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    # Assume it's full-size convolution, so map size is identical to input size : (H, W)
    # Assume the pool params are : {'pool_height': 2, 'pool_width': 2, 'stride': 2}
    # So pooled size will be (H/2, W/2)
